...
public final class CartProfile_jsp extends org.apache.jasper.runtime.HttpJspBase
...
List<Cart> carts = pd.selectAllCarts();
      ...
      out.write("        <title>Food Profile</title>\n");
      ...
      out.write("            <div class=\"card-header my-3\">All Foods </div> \n");
      out.write("            \n");
      out.write("            <form method=\"post\" action=\"processFoodProfile.jsp\">  \n");
      out.write("         <fieldset class=\"form-group\">\n");
      out.write("          <label>Cart ID:</label>\n");
      out.write("          <input type=\"text\" value=\"\"  name=\"cart_id\" required=\"required\"><!-- comment -->                             \n");
      out.write("        </fieldset>\n");
      out.write("\n");
      ...
      out.write("            <img class=\"card-img-top\" src=\"pics/pic.jpg\" alt=\"Why no picture\">\n");
      out.write(" \n");
      out.write("            \n");
      ...
      out.write("</h5>\n");
      out.write("         <fieldset class=\"form-group\">\n");
      out.write("             <h6 class=\"price\">Name: <input style=\"border:0px;\" type=\"text\" value=\"");
      out.print(p.getFoodName());
      out.write("\"  name=\"food_name\" required=\"required\" readonly=\"readonly\"><!-- comment -->    </h6> \n");
      out.write("         </fieldset>\n");
      out.write("         \n");
      out.write("        \n");
      out.write("         \n");
      out.write("         \n");
      out.write("         <fieldset class=\"form-group\">\n");
      out.write("          <h6 class=\"price\">Price: <input style=\"border:0px;\" type=\"text\" value=\"");
      out.print(p.getFoodPrice());
      out.write("\"  name=\"food_price\" required=\"required\" readonly=\"readonly\"><!-- comment -->    </h6> \n");
      out.write("         </fieldset>\n");
      out.write("         \n");
      out.write("          \n");
      out.write("    \n");
