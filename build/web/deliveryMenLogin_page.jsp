<%-- 
    Document   : deliveryMenLogin_page
    Created on : Jul 7, 2021, 2:00:53 AM
    Author     : User
--%>
...
<html>
                        ...
                        <div class="card" style="background-color:#EF9B0F;">
                          ...
                          <%
                           ...
                           %>
                            ...
                            <div class="card-body">
                                <form action="DeliveryMenLoginServlet" method="POST">
  <div class="form-group">
    <label for="exampleInputEmail1">DeliveryMen Name</label>
  ...
  <button type="submit" class="btn btn-primary  text-muted" style="background-color:blanchedalmond">LOG IN</button>
					...
					<div class="d-flex justify-content-center links">
                                            New at work? <a class="ml-2 " href="deliveryMenRegister_page.jsp">Sign Up</a>
</form>
