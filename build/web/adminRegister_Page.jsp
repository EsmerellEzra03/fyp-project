<%-- 
    ...
    Created on : Jun 28, 2021, 1:56:30 AM
    Author     : User
--%>
...
<html>
    ...
    <input name="adminId" required type="text" class="form-control" id="admin_id" aria-describedby="emailHelp" placeholder="E.g AD001">
  </div>
