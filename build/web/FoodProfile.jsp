<%-- 
    Document   : FoodProfile
    Created on : Jul 2, 2021, 3:39:37 PM
    Author     : User
--%>
...
<html>
    <head>
        ...
        <style>
         ...
         clip-path: polygon(30% 0%, 70% 0%, 100% 0, 100% 89%, 86% 96%, 11% 99%, 0 90%, 0 0);
            ...
            <div class="card-header my-3">All Menu Items</div> 
    ...
    <div class="card-body">
         ...
         <h5 class="card-title"><%=p.getFoodId()%></h5>
         
         
         <fieldset class="form-group">
             <h6 class="price">Name: <input style="border:0px;" type="text" value="<%=p.getFoodName()%>"  name="food_name" required="required" readonly="readonly"><!-- comment -->    </h6> 
         </fieldset>
         ...
         <fieldset class="form-group">
          <h6 class="price">Price: <input style="border:0px;" type="text" value="<%=p.getFoodPrice()%>"  name="food_price" required="required" readonly="readonly"><!-- comment -->    </h6> 
         </fieldset>
