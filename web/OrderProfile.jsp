<%-- 
    Document   : OrderProfile
    Created on : Jul 7, 2021, 1:26:20 PM
    Author     : User
--%>
...
List<Order> orders = pd. selectAllOrdersByStatus();
                    ...
                    <thead>
                        <tr>
                            ...
                            <tbody>
                                ...
                                <td><a class="btn btn-sm btn-danger" href="editOrder?order_id=<%=p.getOrderId()%>">Assign Delivery</a></td>
