<%-- 
    Document   : Homepage
    Created on : Jul 8, 2021, 8:31:40 PM
    Author     : User
--%>
...
<body id="myPage"  data-spy="scroll" data-target=".navbar" data-offset="60">
    ...
    <nav class="navbar navbar-expand-md bg-dark navbar-dark fixed-top">
        <a class="navbar-brand" href="#">DeliverEat.com</a>
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="main_loginPage.jsp">Login</a>
                </li>  
            </ul>
        </div>  
    </nav>
    ...
    <div class="jumbotron">
        <div class="container-fluid">
            <div class="header-content-inner">
                <h1 style="font-size:70px">Welcome to DeliverEat.com</h1> 
                <h2 style="font-size:40px">Trust us, your foods will come to you.</h2>
            </div>
        </div>
    </div>
