...
public class AdminLoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String adminAdname=request.getParameter("adname");
            String adminAdpassword=request.getParameter("adpassword");
            
            AdminDao dao = new AdminDao(ConnectionProvider.getConnection());
            
            Admin u=dao.getAdminByNameAndPassword(adminAdname, adminAdpassword);
